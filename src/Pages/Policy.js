                ...
                <div className='rounded-5' style={{ backgroundColor: "#F6F6F6" }}>
                    ...
                    <div>
                        <Container className='py-5 px-4 fs-5 BwGradual'>
                            ...
                            <p>Automatic data collection. We and our service providers may automatically log information about you, your computer or mobile device, and your interaction over time with our Services, our communications and other online services, such as:</p>
                            ...
                            <p>Personal information requests. We also offer you choices that affect how we handle the personal information that we control. You may request the following in relation to your personal information:</p>
