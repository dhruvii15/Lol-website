...
import aboutBgImage from "../../img/cloud.svg"; // Import your background image here
            ...
            <Container id='aboutUsSection' className='overflow-hidden'>
                <div className='text-center BwGradual about-padding'>
                    <Row className='ps-0 ps-lg-5 ms-0 ms-xl-5'>
                        ...
                        <Col className='about-bg order-1 order-lg-2 animation' ref={aboutBgRef}> {/* Add the ref here */}</Col>
                    </Row>
                </div>
                <div className='py-5'>
