    ...
    return (
        <div className='BwGradual fs-5'>
            <div className='pt-5'>
                ...
                <p>In addition to these features, our Community Team works around the clock to monitor user reports and support tickets, providing the LOL community with 24/7 help and guidance. No concern is too small for us; reach out to help@LOLapp.com with any questions. We’re happy to help!</p>
